...
// Perbaikan: Folder-nya bernama 'styles' pakai huruf 's' di belakang
...
export default function SocialMediaPage({ onBack }: SocialMediaProps) {
  return (
    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="max-w-4xl mx-auto pb-20 pt-6 px-4">
      {/* HEADER NAVIGASI */}
      <div className="flex items-center gap-4 mb-16">
        <button onClick={onBack} className="p-2 bg-white hover:bg-slate-100 rounded-full shadow-sm transition-colors text-slate-600">
          <ArrowLeft size={24} />
        </button>
        <h2 className="text-xl font-black text-slate-800 uppercase tracking-widest">Enigma Social</h2>
      </div>

      {/* WADAH ANIMASI SOSIAL MEDIA */}
